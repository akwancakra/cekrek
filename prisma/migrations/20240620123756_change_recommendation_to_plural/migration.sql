...
-- AddForeignKey
ALTER TABLE `child_recommendations`
ADD CONSTRAINT `child_recommendation_recommendation_id_fkey` FOREIGN KEY (`recommendation_id`) REFERENCES `recommendations` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;