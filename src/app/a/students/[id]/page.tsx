...
export default function StudentDetails({}) {
    ...
    const removeStudentButton = async () => {
        if (childData?.child?.id) {
            ...
            // await axios
            //     .put(`/api/admin/children/${childData.child.id}/delete`)
            //     .then(() => {
            //         toast.success("Siswa berhasil dihapus!");
            //         setIsSubmit(false);
            //         push("/t");
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-56" align="end">
                                ...
                                <DropdownMenuGroup>
                                    ...
                                    >
                                        <Link
                                            href={`/a/students/${data?.id}/recommendation`}
                                        >
                                    ...
                                    >
                                        <Link
                                            href={`/a/students/${data?.id}/assessment`}
                                        >
                                            <span className="material-symbols-outlined cursor-pointer me-1 !text-xl !leading-4 opacity-70">
                                                assignment
                                            </span>{" "}
                                            ...
                                            <TableCell className="w-2 text-center">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        ...
                                                        >
                                                            <Link
                                                                href={`/a/students/${id}/recommendation?date=${formattedDateStripYearFirst(
                                                                    monitor.date
                                                                )}`}
                                                            >
                                                                <span className="material-symbols-outlined cursor-pointer me-1 !text-xl !leading-4 opacity-70">
