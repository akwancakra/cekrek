...
export default function Template({}) {
    ...
    const [historyAssessmen, setHistoryAssessmen] = useState<
        ProcessedAssessment[]
    >([]);
    const { profile: userProfile, isReady } = useProfile();
    ...
    const {
        ...
        isReady &&
            userProfile?.id &&
            `/api/parents/${userProfile?.id}/children/${id}`,
        fetcher
    );
                ...
                <>
                    ...
                    <div className="block gap-4 group-[.open]:block lg:group-[.open]:flex md:flex">
                        ...
                        <div className="w-full mt-3 group-[.open]:w-full group-[.open]:mt-3 lg:group-[.open]:w-2/3 lg:group-[.open]:mt-0 md:w-2/3 md:mt-0">
                            <div className="skeleton h-60 mb-3 rounded-lg"></div>
                            <div className="skeleton h-60 mb-3 rounded-lg"></div>
                            <div className="skeleton h-60 mb-3 rounded-lg"></div>
                        </div>
                    </div>
                ...
                <>
                    ...
                    <div className="block gap-4 group-[.open]:block lg:group-[.open]:flex md:flex">
                        ...
                        <div className="w-full mt-3 group-[.open]:w-full group-[.open]:mt-3 lg:group-[.open]:w-2/3 lg:group-[.open]:mt-0 md:w-2/3 md:mt-0">
                            ...
                            {/* BIODATA */}
                            <div className="border border-gray-300 p-2 rounded-lg my-3 dark:border-gray-600">
                                <div>
