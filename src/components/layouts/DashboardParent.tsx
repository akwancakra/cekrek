...
import SidebarParent from "../elements/sidebars/SidebarParent";

const DashboardParent = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <section>
            <SidebarParent isOpen={isOpen} toggleSidebar={toggleSidebar} />
