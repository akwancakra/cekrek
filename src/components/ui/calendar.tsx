    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    "bg-primary text-gray-50 hover:bg-primary-foreground hover:text-gray-50 focus:bg-primary focus:text-gray-50 dark:bg-gray-50 dark:text-primary-foreground dark:hover:bg-gray-50 dark:hover:text-primary-foreground dark:focus:bg-gray-50 dark:focus:text-primary-foreground",
                day_today:
                    "bg-gray-100 text-primary dark:bg-gray-800 dark:text-gray-50",
                day_outside:
